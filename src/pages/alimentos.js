  ...
  return (
    <div>
      ...
      <div className="text-center my-8">
        <h3 className={`${styles.AlimentosTitle} text-xl font-bold mb-4`}>
          ALIMENTOS
        </h3>
      </div>
      ...
      <div className="flex p-4">
        ...
        >
          ...
          <button
            ...
            className="text-black p-2 bg-gray-300 rounded-lg w-full"
          >
            RESET
          </button>
        </div>
        ...
        <div className="w-3/4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {productos.map((producto) => (
            <div
              ...
              onClick={() => handleProductClick(producto)} // Agregar el evento onClick
            >
