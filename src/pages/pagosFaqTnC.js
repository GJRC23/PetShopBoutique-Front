    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow p-4 md:p-8">
        ...
        <section className="mb-12 md:mb-16">
          <h3
            className={`${styles.pagosTitle} text-4xl md:text-6xl font-bold mb-4 text-center md:text-left`}
          >
            MEDIOS DE PAGO
          </h3>
          <h3 className="mb-2 font-semibold text-4x1 md:text-2x1">
        ...
        <section className="mb-12 md:mb-16">
          ...
          <div className="mb-4">
            <h3 className="font-semibold text-4x1 md:text-2x1">
              ¿ Cuál es su horario ?
            </h3>
